...
namespace RemoteTaskQueue.FunctionalTests.TaskCounter
{
    ...
    [EdiTestSuite("TaskCounterTestSuite"), WithTestRemoteTaskQueue, WithExchangeServices]
    public class TaskCounterTest
    {
        ...
        public void TestOldWaitingTaskCount()
        {
            ...
            container.Get<ExchangeServiceClient>().Start();
            WaitFor(() =>
                {
        ...
        [Injected]
        private readonly TaskCounterServiceClient monitoring;
