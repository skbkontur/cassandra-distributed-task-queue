...
export default class TaskDetailsMetaTable extends React.Component {
    ...
    renderMetaInfo(): React.Element<*>[] {
        ...
        return [
            ...
            <tr key="EnqueueTime">
                <td>EnqueueTime</td>
                <td data-tid="EnqueueTime">
                    {renderDate(taskMeta.ticks)}
                </td>
            </tr>,
            <tr key="StartExecutedTime">
                <td>StartExecutedTime</td>
                <td data-tid="StartExecutedTime">
                    {renderDate(taskMeta.startExecutingTicks)}
                </td>
            </tr>,
            <tr key="FinishExecutedTime">
                <td>FinishExecutedTime</td>
                <td data-tid="FinishExecutedTime">
                    {renderDate(taskMeta.finishExecutingTicks)}
                </td>
            </tr>,
            <tr key="MinimalStartTime">
                <td>MinimalStartTime</td>
                <td data-tid="MinimalStartTime">
                    {renderDate(taskMeta.minimalStartTicks)}
                </td>
            </tr>,
            <tr key="ExpirationTime">
                <td>ExpirationTime</td>
                <td data-tid="ExpirationTime">
                    {renderDate(taskMeta.expirationTimestampTicks)}
                </td>
            </tr>,
            <tr key="ExpirationModificationTime">
                <td>ExpirationModificationTime</td>
                <td data-tid="ExpirationModificationTime">
                    {renderDate(taskMeta.expirationModificationTicks)}
                </td>
            </tr>,
            <tr key="LastModificationTime">
                <td>LastModificationTime</td>
                <td data-tid="LastModificationTime">
                    {renderDate(taskMeta.lastModificationTicks)}
                </td>
            </tr>,
            <tr key="Attempts">
                <td>Attempts</td>
                <td data-tid="Attempts">
                    {taskMeta.attempts}
                </td>
            </tr>,
            <tr key="ParentTaskId">
                ...
                <td data-tid="ParentTaskId">
                    {taskMeta.parentTaskId &&
                        <a href={"/AdminTools/Tasks/" + taskMeta.parentTaskId}>
                            {taskMeta.parentTaskId}
                        </a>}
                </td>
            </tr>,
