            ...
            <Modal data-tid="Modal" onClose={() => this.closeModal()} width={900}>
                ...
                <ModalBody>
                    ...
                    <ol className={cn("modal-list")}>
                        <li>
                            Ввод значения без дополнительных указаний. В этом случае найдутся все задачи, в полях
                            которых встречается это значение.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            типов: Meta и Data, в полях Meta лежит общая информация по задаче, в полях Data - информация
                            по типу задачи.<br />
                        ...
                        <li>
                            ...
                            Звездочка не может быть в начале искомого значения (<code>Data.ScopeId:*lue</code> не
                            работает).<br />
                            Знаки можно использовать не только в значениях, но и при указании полей. По запросу{" "}
                            <code>Data.\*Id:value</code> во всех поля даты, которые заканчиваются на id найдётся value.
                        </li>
                        <li>
