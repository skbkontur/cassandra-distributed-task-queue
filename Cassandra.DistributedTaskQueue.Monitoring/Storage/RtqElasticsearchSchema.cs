...
public class RtqElasticsearchSchema
{
    ...
    public void Actualize(bool local, bool bulkLoad)
    {
        ...
        var indexSettingsPostData = PostData.String(JsonSerializer.Serialize(indexSettings));
        ...
        var templateSettingsPostData = PostData.String(JsonSerializer.Serialize(templateSettings));
    ...
    private readonly CreateIndexRequestParameters allowResourceAlreadyExistsStatus = new()
        {
