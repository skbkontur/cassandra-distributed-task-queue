...
{
    public class RtqElasticsearchIndexerGraphiteReporter
    {
        public RtqElasticsearchIndexerGraphiteReporter([NotNull] string graphitePrefix, IStatsDClient statsDClient)
        {
