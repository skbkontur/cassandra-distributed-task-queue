...
namespace SKBKontur.Catalogue.RemoteTaskQueue.TaskMonitoringViewer.ModelBuilders.TaskDetails
{
    ...
    {
        public TaskDetailsHtmlModelBuilder(IObjectTreeValueModelBuilder objectTreeValueModelBuilder, IRemoteTaskQueueHtmlModelCreator<TaskDetailsModel> htmlModelCreator)
        {
            ...
            return new TaskDetailsHtmlModel
                {
                    ...
                    TaskDataValue = objectTreeValueModelBuilder.Build(pageModel.Data.TaskData, (url, path) => url.GetTaskDataBytesUrl(pageModel.Data.TaskMetaInfoModel.TaskId, path)),
