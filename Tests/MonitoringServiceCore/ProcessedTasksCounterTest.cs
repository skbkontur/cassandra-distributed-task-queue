...
namespace RemoteQueue.Tests.MonitoringServiceCore
{
    ...
    public class ProcessedTasksCounterTest
    {
        ...
        public void TestSimple()
        {
            ...
            counter.NewMetainformationAvailable(CreateMetas(CreateMeta("a", TaskState.New, null)), 100);
        ...
        {
            counter.GetCount().AssertEqualsTo(new TaskCount {Count = count, UpdateTicks = ticks});
            counter.GetNotFinishedTasksCount().AssertEqualsTo(count); //note debug check
        }
