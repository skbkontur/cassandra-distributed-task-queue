...
namespace SKBKontur.Catalogue.RemoteTaskQueue.ElasticMonitoring.UnitTests
{
    ...
    public class MetaProviderTest : CoreTestBase
    {
        public override void SetUp()
        {
            ...
            metaProvider = new MetaProviderImpl(lifeTicks, maxBatch, 0, eventLog, metaStorage, "test");
        }
        ...
        {
            metaProvider = new MetaProviderImpl(lifeTicks, maxBatch, 11, eventLog, metaStorage, "test2");
            ...
            metaProvider.LoadSnapshot(new MetaProviderSnapshot(100, 100, null, null), 101);
        ...
        private void DoTest(long lastTicks, long nowTicks, TaskMetaUpdatedEvent[] events, string[] ids, TaskMetaInformation[] readMetas, int[] goodMetas)
        {
            ...
            if(goodMetas != null)
            {
                ...
                metaConsumer.Expect(c => c.ProcessMetas(ARG.EqualsTo(metasToUpdate), ARG.EqualsTo(nowTicks)));
            }

            metaProvider.LoadMetas(nowTicks, new[] {metaConsumer,});
        ...
        private MetaProviderImpl metaProvider;
